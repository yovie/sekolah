...
<div class="ba-info">
  <img src="<?php  echo  get_ba_options('url'); ?>assets/images/icon-big.png" alt="<?php echo get_ba_options('name'); ?>" title="<?php echo get_ba_options('name'); ?>" width="128" height="128" class="alignleft"/>
